...
module.exports = class RulesCommand extends Commando.Command {
    constructor(client) {
        super(client, {
            name: 'rules',
            group: 'server',
    ...
    async run(message) {
        ...
        const rule2Embed = new Discord.MessageEmbed()
            ...
            \n<:six:760541245352968283> - **No NSFW or NSFL** content that includes gore, shock, nudity, and/or other disturbing graphics. This includes your username, profile picture, and your status.
        ...
        const rule3Embed = new Discord.MessageEmbed()
            ...
            .setFooter('REVISION 4.2 - As of APRIL 21, 2021')
        ...
        const rule4Embed = new Discord.MessageEmbed()
            ...
            .setDescription(`<:one:760528410106920961> - **Do not enter and leave** a voice channel repeatedly. This will annoy members within the call with the constant noise of someone joining and leaving.
            \n<:two:760529046902931487> - **Do not make excessively loud and obnoxious noises** while in a call. This will also annoy any members within the voice channel and it results in an immediate temporary ban from all voice channels (the time depends on the moderator).
            \n<:three:760529217581482014> - **Do not spam the mute/unmute button** as it will make you sound like you keep cutting out. This can cause some confusing between the voice channel members.
            \n<:four:760532025584648203> - **Do not switch between different voice channels repeatedly**.`)
            .setFooter('REVISION 1.1 - As of JANUARY 19, 2021')
        ...
        const discipline1Embed = new Discord.MessageEmbed()
            ...
            \nOnce you have read all the messages here and agree that you will follow the rules, type: \`\`\`-accept\`\`\` in <#671856010583080967> to get <@&763412201427697725> and gain access to the rest of the server.`)
